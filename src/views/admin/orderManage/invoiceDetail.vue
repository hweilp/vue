                    ...
                    <el-row>
                      ...
                      <el-col :span="12">
                        <el-form-item label="发货状态 ：" prop="">
                          <el-input v-model="FG_InvoiveDetail.baseInfo.invoiceStatusStr" disabled></el-input>
                        </el-form-item>
                      </el-col>
                      <!-- <el-col :span="12">
  ...
  export default {
    ...
    methods: {
      ...
      FG_TABLE_refreshData: function () {
        ...
        this.$http(this.$_.merge({}, Action.Order.InvoiceList.detail, {
          params
        })).then(response => {


          Helper.FG.setValueToObject(this.FG_InvoiveDetail.dispatchInfo, response.body.addressView)
          this.FG_InvoiveDetail.dispatchInfo.id = response.body.id

          Helper.FG.setValueToObject(this.FG_InvoiveDetail.baseInfo, response.body)

          this.FG_TABLE.data = response.body.detailViews
