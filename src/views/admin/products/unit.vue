    ...
    <div id="main" class="fg-table-type" role="main">
      <div id="shopUnit">
          ...
          <div class="content">
            ...
            <el-row :span="24" class="fg-content-detail">
              <el-row :span="24" class="fg-content-opr">
                <el-button v-if="power.indexOf(12111301) > -1 ? true : false"  :plain="true" type="primary" size="" @click="FG_TABLE_showAddRowForm"><i
                  class="fa fa-plus"></i> 新增
                </el-button>
                <el-button  v-if="power.indexOf(12111302) > -1 ? true : false" :plain="true" type="primary" size="" @click="FG_TABLE_showEditRowForm"><i
                  class="fa fa-edit"></i> 编辑
                </el-button>
                <el-button  v-if="power.indexOf(12111303) > -1 ? true : false" :plain="true" type="danger" size="" @click="FG_TABLE_showDeleteRowForm"><i
        ...
        top: -6px;">全选</span>
              ...
              <!-- 增加 -->
                  <el-dialog title="商品单位-新增" :visible.sync="FG_TABLE.addRow.is_show">
                    <el-form ref="addForm" :model="FG_TABLE.addRow.data" label-width="100px"
                      ...
                      <el-form-item label="备注 : " class="noAfter" prop="remark">
              ...
              <!-- 修改 -->
              <el-dialog title="修改商品单位" :visible.sync="FG_TABLE.editRow.is_show">
                <el-form ref="editFrom" :model="FG_TABLE.editRow.data" label-width="100px" :rules="FG_TABLE.editRow.rules">
                  ...
                  <el-form-item label="备注 : " class="noAfter">
  ...
  export default {
      ...
      return {
        ...
        FG_TABLE: {
          ...
          editRow: {
            ...
            rules: Rules.Product.Unit.editForm
          },
          addRow: {
            name: 'addForm',
            is_show: false,
            ...
            rules: Rules.Product.Unit.addForm
          },
          loading: {
            is_loading: false,
            loadText: '',
    ...
    methods :{
      ...
      FG_TABLE_refreshData: function (option) {
        ...
        if(this.$store.state.User.unit != null) this['User/INIT_USER_UNIT'](null);

        this.$http(this.$_.merge({}, Action.Product.Unit.list, {
          params
        })).then(response => {
          //表格数据
      ...
      FG_TABLE_onEditRowSubmit: function (formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            // 提交
            this.$http(this.$_.merge({}, Action.Product.Unit.update, {
              //获取待更新数据
        ...
        if (this.FG_TABLE.multiSelectData.length >= 1) {
          ...
          this.$confirm('确认删除？')
            .then(_ => {
              ...
              this.$http(this.$_.merge({}, Action.Product.Unit.delete, {
                //获取待更新数据
                body: params
              })).then(response => {
