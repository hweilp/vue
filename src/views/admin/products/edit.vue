            ...
            <el-tab-pane label="基本信息" name="1">
              <el-form :model="FG_basicInfoForm.data" :rules="FG_basicInfoForm.rules" ref="FG_basicInfoForm"
                ...
                <el-row :span="24" class="fg-content-bar">
                  ...
                  <el-row :span="24">
                    <el-form-item label="生产日期：" prop="promoteDate">
                      <!-- <el-input v-model="FG_basicInfoForm.data.promoteDate"></el-input>-->
                ...
                <el-row :span="24" class="fg-content-bar">
                  ...
                  <el-form-item label="商品内部属性：" prop="internalType" style="margin-right: 251px;">
                    <el-select v-model="FG_basicInfoForm.data.internalType" placeholder="A类">
                      <el-option
                ...
                <el-row :span="24" class="fg-content-bar">
                  ...
                  <el-row :span="24" style="margin-top: 20px">
                    <el-form-item label="初始库存：" prop="initialStock" style="margin-right: 30px">
                      <el-input v-model.number="FG_basicInfoForm.data.initialStock" disabled></el-input>
                    </el-form-item>
                ...
                <el-row :span="24" class="fg-content-bar">
                  ...
                  <el-row :span="24" style="margin-top: 20px">
                    ...
                    <template v-if="FG_basicInfoForm.data.commissionType == 2">
                      <el-form-item label="请输入提成比例%：" prop="commissionValue">
                    ...
                    <template v-if="FG_basicInfoForm.data.commissionType == 3">
                      <el-form-item label="请输入提成金额￥：" prop="commissionValue">
                        <el-input v-model.number="FG_basicInfoForm.data.commissionValue"></el-input>
                      </el-form-item>
                    </template>
                ...
                <el-row :span="24" class="fg-content-bar">
                  ...
                  <el-row :span="24" style="margin-top: 20px">
                    <el-form-item label="供应商：" prop="">
                      ...
                      <supplier-select-plus :supplierSelected.sync="FG_basicInfoForm.data.sno"></supplier-select-plus>

                    </el-form-item>
                    <el-form-item label="供应商合同状态：" prop="">
                      <el-radio-group v-model="FG_basicInfoForm.data.supplyStatus">
                  ...
                  <el-form-item label="供货合同有效期：" prop="">
                    <el-date-picker
                      v-model="FG_basicInfoForm.data.expiryDate"
                      align="right"
                      placeholder="选择日期"
                      :editable="false"
                      style="width: 360px"
            ...
            <el-tab-pane label="详情信息" name="2">
              <el-form :model="FG_detailInfoForm.data" :rules="FG_detailInfoForm.rules" ref="FG_detailInfoForm"
                ...
                <el-row :span="24" class="fg-content-bar">
                  ...
                  <el-form-item label="轮播图：" prop="slidePictureUrl">
                    <!--  <el-input v-model="FG_detailInfoForm.data.slidePictureUrl" style="display: none"></el-input>-->
                    <imgs-upload :pictureUrls.sync="FG_detailInfoForm.data.slidePictureUrl"
...
<script type="text/javascript">
  ...
  export default {
    ...
    created: function () {
      if (this.$route.query.pno) {
        //查询单条基本信息
        this.$http(this.$_.merge({}, Action.Product.Info.singleBasic, {
          params: this.$route.query
        }))
          .then(response => {
            this.FG_basicInfoForm.data.pictureUrl = response.body.masterPictures

            Helper.FG.setValueToObject(this.FG_basicInfoForm.data, response.body)

            this.FG_basicInfoForm.data.pno = this.$route.query.pno

            this.FG_basicInfoForm.data.buyingPrice=Number(this.FG_basicInfoForm.data.buyingPrice)
            this.FG_basicInfoForm.data.minPrice=Number(this.FG_basicInfoForm.data.minPrice)
            this.FG_basicInfoForm.data.memberPrice=Number(this.FG_basicInfoForm.data.memberPrice)
            this.FG_basicInfoForm.data.retailPrice=Number(this.FG_basicInfoForm.data.retailPrice)

          }, response => {
            this.$message.error(response.body.resultMessage, response.body)
          })
        //查询单条详情信息
        this.$http(this.$_.merge({}, Action.Product.Info.singleDetail, {
          params: this.$route.query
        }))
          .then(response => {

            Helper.FG.setValueToObject(this.FG_detailInfoForm.data, response.body)
            this.FG_detailInfoForm.data.slidePictureUrl = response.body.slidePictures
            this.FG_detailInfoForm.data.detailPictureUrl = response.body.detailPictures
    ...
    watch: {
      ...
      'FG_basicInfoForm.data.expiryDate': function (val) {
        if (val) {
          this.FG_basicInfoForm.data.expiryDate = Helper.FG.formatDate(val)
        }
      },
    ...
    methods: {
      ...
      FG_handleBasicInfoForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$http(this.$_.merge({headers:{}}, Action.imgUpload.remove, {
            ...
            this.$http(this.$_.merge({}, Action.Product.Info.update, {
              body: this.FG_basicInfoForm.data
            }))
              .then(response => {
                this.$message.success('修改商品基本信息成功', response.body)
      ...
      FG_handleDetailInfoForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.FG_detailInfoForm.data.slidPictureUrl = this.FG_detailInfoForm.data.slidePictureUrl

            this.FG_detailInfoForm.data.pno = this.FG_basicInfoForm.data.pno
            this.$http(this.$_.merge({}, Action.Product.Info.updateDetail, {
              body: this.FG_detailInfoForm.data
            }))
              .then(response => {
                this.$message.success('修改商品详情信息成功', response.body)
