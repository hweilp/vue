<template>
  ...
  <div>
    <div id="main" class="fg-table-type" role="main">
      <div id="purshaseSupplierCollect">

        <div class="container">
          <div class="content">
            <el-row :span="24" class="fg-content-title">采购查询 - 采购供应商汇总</el-row>
            <el-row :span="24" class="fg-content-detail">
              ...
              >
                ...
                <el-table-column prop="date" label="供应商编码" width="140" sortable></el-table-column>
                <el-table-column prop="ART_num" label="供应商"></el-table-column>
