<template>
  <div>
    <div id="main" class="fg-table-type" role="main">
      <div id="purshaseDateCollect">

        <div class="container">
          <div class="content">
            <el-row :span="24" class="fg-content-title">采购查询 - 采购日汇总</el-row>
            <el-row :span="24" class="fg-content-detail">
                    ...
                    <el-row>
                        ...
                        <el-form-item label="日期 ：" >
                          <div class="group">
                            <el-form-item prop="dateStart">
                              <el-date-picker type="date" placeholder="选择起始日期" v-model="FG_TABLE.pagination.pageFilter.filters.dateStart"  ></el-date-picker>
                            </el-form-item>
                            <i class="fa fa-minus linkIcon"></i>
                            <el-form-item prop="dateEnd">
                              <el-date-picker type="date" placeholder="选择日期" v-model="FG_TABLE.pagination.pageFilter.filters.dateEnd" :picker-options="FG_TABLE.pagination.pageFilter.filtersOptions.pickerOptionsEnd"></el-date-picker>
                            </el-form-item>
                          </div>
                        </el-form-item>
                      </el-col>
                      ...
                      <el-col :span="12">
                        <el-form-item label="门店 ：" prop="store">
                          ...
                          <el-select v-model="FG_TABLE.pagination.pageFilter.filters.store" placeholder="" style="width: 360px" >
                      ...
                      <el-col :span="12">
                        <el-form-item label="品名 ：" prop="brandName">
                          <el-input v-model="FG_TABLE.pagination.pageFilter.filters.brandName"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                        <el-form-item label="金额 ：">
                          <div class="group">
                            <el-form-item prop="moneyStart"><el-input v-model="FG_TABLE.pagination.pageFilter.filters.moneyStart"></el-input></el-form-item>
                            <i class="fa fa-minus linkIcon"></i>
                            <el-form-item prop="moneyEnd"><el-input v-model="FG_TABLE.pagination.pageFilter.filters.moneyEnd"></el-input></el-form-item>
                          </div>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                        <el-form-item label="金额小计 ：">
                          <div class="group">
                            <el-form-item prop="moneySubtotalStart"><el-input v-model="FG_TABLE.pagination.pageFilter.filters.moneySubtotalStart"></el-input></el-form-item>
                            <i class="fa fa-minus linkIcon"></i>
                            <el-form-item prop="moneySubtotalEnd"><el-input v-model="FG_TABLE.pagination.pageFilter.filters.moneySubtotalEnd"></el-input></el-form-item>
                          </div>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
              ...
              >
                ...
                <el-table-column prop="ART_num" label="货号"></el-table-column>
                <el-table-column prop="brand_name" label="品名"></el-table-column>
                <el-table-column prop="spec" label="规格"></el-table-column>
                <el-table-column prop="unit" label="单位"></el-table-column>
                <el-table-column prop="income_num" label="采购数量" width="100"></el-table-column>
                <el-table-column prop="income_money" label="采购金额" width="100"></el-table-column>
                <el-table-column prop="out_num" label="采购赠送" width="100"></el-table-column>
                <el-table-column prop="out_num" label="退货数量" width="100"></el-table-column>
              ...
              <store-query :storeQueryShow="FG_STOREQUERY.storeQueryShow" @on-show-change="showChange" @on-get-value="getStoreName"></store-query>
