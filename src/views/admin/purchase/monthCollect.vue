<template>
  ...
  <div>
    <div id="main" class="fg-table-type" role="main">
      <div id="purshaseMonthCollect">

        <div class="container">
          <div class="content">
            <el-row :span="24" class="fg-content-title">采购查询 — 采购月汇总</el-row>
            <el-row :span="24" class="fg-content-detail">
                    ...
                    <el-row>
                      <el-col :span="12">
                        <el-form-item label="月份 ：" prop="month">
                          <div class="block">
                            <el-date-picker
                              v-model="FG_TABLE.pagination.pageFilter.filters.month"
                              type="month"
                              placeholder="选择月">
                            </el-date-picker>
                          </div>
                      ...
                      <el-col :span="12">
                        <el-form-item label="门店 ：" prop="store">
                          ...
                          <el-select v-model="FG_TABLE.pagination.pageFilter.filters.store" placeholder="总部"
                                     style="width: 360px">
                      ...
                      <el-col :span="12">
                        <el-form-item label="数量小计 ：">
                          <div class="group">
                            <el-form-item prop="numStart">
                              <el-input v-model="FG_TABLE.pagination.pageFilter.filters.numStart"></el-input>
                            </el-form-item>
                            <i class="fa fa-minus linkIcon"></i>
                            <el-form-item prop="numEnd">
                              <el-input v-model="FG_TABLE.pagination.pageFilter.filters.numEnd"></el-input>
                            </el-form-item>
                          </div>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                        <el-form-item label="金额小计 ：">
                          <div class="group">
                            <el-form-item prop="moneySubtotalStart">
                              <el-input v-model="FG_TABLE.pagination.pageFilter.filters.moneySubtotalStart"></el-input>
                            </el-form-item>
                            <i class="fa fa-minus linkIcon"></i>
                            <el-form-item prop="moneySubtotalEnd">
                              <el-input v-model="FG_TABLE.pagination.pageFilter.filters.moneySubtotalEnd"></el-input>
                            </el-form-item>
                          </div>
                        </el-form-item>
                      </el-col>
              ...
              >
                ...
                <el-table-column prop="date" label="月份" width="120" sortable></el-table-column>
                ...
                <el-table-column prop="income_num" label="采购数量" width="120"></el-table-column>
                <el-table-column prop="income_money" label="采购金额"></el-table-column>
                <el-table-column prop="out_num" label="采购赠送"></el-table-column>
                <el-table-column prop="out_num" label="退货数量"></el-table-column>
                <el-table-column prop="out_money" label="退货金额"></el-table-column>
                <el-table-column prop="out_num" label="退货赠送"></el-table-column>
                <el-table-column prop="" label="数量小计"></el-table-column>
