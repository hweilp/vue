        ...
        <div class="content">
          ...
          <el-row :span="24" class="fg-content-detail">
            <el-row :span="24" class="fg-content-opr" style="position: relative;">
              ...
              <router-link to="/purchase/purshaseAdd">
                <el-button><i class="fa fa-plus" style="margin-right: 3px"></i>新增</el-button>
              </router-link>

              <el-button :plain="true" type="primary" size="" style="margin-left: 10px;" @click="FG_TABLE_initData"><i class="fa fa-refresh"></i>
                刷新
              </el-button>
              ...
              <advQuery left="left:535px" :data="FG_QUERYDATA"></advQuery>
