<template>
  <div>
    <div id="main" class="fg-table-type" role="main">
      <div id="purshaseCategoryCollect">

        <div class="container">
          <div class="content">
            <el-row :span="24" class="fg-content-title">采购查询 - 采购类别汇总</el-row>
            <el-row :span="24" class="fg-content-detail">
                ...
                <adv-query left="left:555px">
                  <el-form ref="advQueryForm" :model="FG_TABLE.pagination.pageFilter.filters" label-width="100px">
                    <el-row>
                      ...
                      <el-col :span="12">
                        <el-form-item label="类别汇总 ：" prop="categoryType">
                          <el-radio-group v-model="FG_TABLE.pagination.pageFilter.filters.categoryType">

                            <el-radio
                              v-for="item in FG_TABLE.pagination.pageFilter.filtersOptions.categoryTypeOptions"
                              :key="item.value"
                              :label="item.value"
                            >{{item.label}}
                            </el-radio>
              ...
              >
                ...
                <el-table-column prop="date" label="类别编码" width="120" sortable></el-table-column>
                <el-table-column prop="ART_num" label="类别"></el-table-column>
                <el-table-column prop="brand_name" label="采购数量"></el-table-column>
                <el-table-column prop="spec" label="采购金额"></el-table-column>
                <el-table-column prop="unit" label="采购赠送"></el-table-column>
                <el-table-column prop="income_num" label="退货数量" width="120"></el-table-column>
