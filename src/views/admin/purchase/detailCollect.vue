<template>
  <div>
    <div id="main" class="fg-table-type" role="main">
      <div id="purshaseDetailCollect">

        <div class="container">
          <div class="content">
            <el-row :span="24" class="fg-content-title">采购查询 — 采购明细汇总</el-row>
            <el-row :span="24" class="fg-content-detail">
                    ...
                    <el-row>
                      ...
                      <el-col :span="12">
                        <el-form-item label="单号 ：" prop="oddNumber">
                          <el-input v-model="FG_TABLE.pagination.pageFilter.filters.oddNumber"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                        <el-form-item label="货号 ：" prop="brandName">
                          <el-input v-model="FG_TABLE.pagination.pageFilter.filters.brandName"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                        <el-form-item label="单据类型 ：" prop="documentType">
                          <el-radio-group v-model="FG_TABLE.pagination.pageFilter.filters.documentType">
                            <el-radio
                              v-for="item in FG_TABLE.pagination.pageFilter.filtersOptions.documentTypeOptions"
                              :key="item.value"
                              :label="item.value"
                            >{{item.label}}
                            </el-radio>
              ...
              >
                ...
                <el-table-column prop="" label="单号" width="140" sortable></el-table-column>
                <el-table-column prop="" label="单据类型" width="100"></el-table-column>
                ...
                <el-table-column prop="" label="采购数量" width="100"></el-table-column>
