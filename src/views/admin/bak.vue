  ...
  <div>
    <header id="header">
      <div id="logo-group">
        ...
        <span id="logo"> <img src="/static/admin/core/img/logo.png" alt="SmartAdmin"> </span>
      ...
      <div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it -->
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="/static/admin/core/img/avatars/sunny.png" alt="me" class="online"/>
						<span>
							john.doe
						</span>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <a href="chartjs.html">Chart.js <span
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <a href="datatables.html">Data Tables <span
          ...
          <li>
            <a href="widgets.html"><i class="fa fa-lg fa-fw fa-list-alt"></i> <span
          ...
          <li class="active">
            ...
            <ul>
              <li>
                <a href="http://bootstraphunter.com/smartadmin-landing/" target="_blank">Landing Page <i
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  target="_blank"><i class="fa fa-book"></i> Documentation</a>
              </li>
              <li>
                <a href="http://bootstraphunter.com/smartadmin/BUGTRACK/track_/" target="_blank"><i
                  class="fa fa-bug"></i>
                  Bug Tracker</a>
              </li>
            </ul>
          ...
          <li class="chat-users top-menu-invisible">
            <a href="#"><i class="fa fa-lg fa-fw fa-comment-o"><em
            ...
            <ul>
              <li>
                <div class="display-users">
                  ...
                  <dl>
                    <dt>
                      <a href="#" class="usr"
                         ...
                         data-content="
												<div class='usr-card'>
													<img src='/static/admin/core/img/avatars/5.png' alt='Sadi Orlaf'>
                    ...
                    <dt>
                      <a href="#" class="usr"
                         ...
                         data-content="
												<div class='usr-card'>
													<img src='/static/admin/core/img/avatars/1.png' alt='Jessica Dolof'>
													<div class='usr-card-content'>
														<h3>Jessica Dolof</h3>
                    ...
                    <dt>
                      <a href="#" class="usr"
                         ...
                         data-content="
												<div class='usr-card'>
													<img src='/static/admin/core/img/avatars/3.png' alt='Zekarburg Almandalie'>
													<div class='usr-card-content'>
                    ...
                    <dt>
                      <a href="#" class="usr"
                         ...
                         data-content="
												<div class='usr-card'>
													<img src='/static/admin/core/img/avatars/4.png' alt='Barley Krazurkth'>
													<div class='usr-card-content'>
                    ...
                    <dt>
                      <a href="#" class="usr offline"
                         ...
                         data-content="
												<div class='usr-card'>
													<img src='/static/admin/core/img/avatars/female.png' alt='Farhana Amrin'>
													<div class='usr-card-content'>
														<h3>Farhana Amrin</h3>
                    ...
                    <dt>
                      <a href="#" class="usr offline"
                         ...
                         data-content="
												<div class='usr-card'>
													<img src='/static/admin/core/img/avatars/male.png' alt='Lezley Jacob'>
													<div class='usr-card-content'>
														<h3>Lezley Jacob</h3>
														<p>Sales Director</p>
													</div>
                  ...
                  <a href="chat.html"
                     class="btn btn-xs btn-default btn-block sa-chat-learnmore-btn">About the API</a>
                </div>
              </li>
            </ul>
          </li>
...
<style lang="scss">
  @import "/static/admin/core/css/bootstrap.min.css";
  @import "/static/admin/core/css/font-awesome.min.css";
  @import "/static/admin/core/css/smartadmin-production-plugins.min.css";
  @import "/static/admin/core/css/smartadmin-production.min.css";
  @import "/static/admin/core/css/smartadmin-skins.min.css";
  @import "/static/admin/core/css/smartadmin-rtl.min.css";
