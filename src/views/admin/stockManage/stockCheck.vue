        ...
        <div class="content">
          ...
          <el-row :span="24" class="fg-content-detail">
            <el-row :span="24" class="fg-content-opr">
              <router-link v-if="power.indexOf(16111301) > -1 ? true : false"  to="/stock/stockCheckAdd" style="margin-right: 10px">
                <el-button :plain="true" type="primary" size=""><i
                  class="fa fa-plus"></i> 新增
                </el-button>
              </router-link>

              <el-button v-if="power.indexOf(16111302) > -1 ? true : false"  :plain="true" type="primary" size="" @click="FG_TABLE_handleAudit"><i
              ...
              <advQuery left="left:655px">
                <el-form ref="advQueryForm" :model="FG_advQueryForm" label-width="90px" :inline="true">
                  ...
                  <el-row :span="24">
                    <el-form-item label="制单人：" prop="createEmpId">
                      <employee-select :employeeSelected.sync="FG_advQueryForm.createEmpId"></employee-select>
                    </el-form-item>
                  ...
                  <el-row :span="24">
                    <el-form-item label="状态：" prop="status">
                      <el-radio-group v-model="FG_advQueryForm.status">
                        <el-radio :label="10">未审核</el-radio>
  ...
  export default {
    ...
    methods: {
      ...
      FG_TABLE_refreshData: function (option) {
        ...
        this.$http(this.$_.merge({}, Action.Stock.stockCheck.list, {
          params
        })).then(response => {
          //表格数据
      ...
      FG_TABLE_showEditRowForm: function () {
        ...
        if (this.FG_TABLE.multiSelectData.length === 1) {
          ...
          this.$router.push({path:'/stock/stockCheckEdit',query:{tid:id}})
      ...
      //编辑
      handleEdit(val){
        this.$router.push({path:'/stock/stockCheckEdit',query:{tid :val}})
      },
      //审核
