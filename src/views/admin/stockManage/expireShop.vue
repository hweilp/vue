          ...
          <div class="content">
            ...
            <el-row :span="24" class="fg-content-detail">
              ...
              >
                ...
                <el-table-column prop="expireDate" label="到期日期" width="120" sortable></el-table-column>
                <el-table-column prop="daysRemaining" label="剩余天数" show-overflow-tooltip></el-table-column>
