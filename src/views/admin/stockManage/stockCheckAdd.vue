      ...
      <div class="content">
        ...
        <el-row :span="24" class="fg-content-detail">
          <el-row :span="24" class="fg-content-opr">
            ...
            <el-button :plain="true" type="primary" size="" @click="FG_handleOrderAudit" :disabled="FG_order.orderStatus" v-if="!FG_order.orderStatus"><i
            ...
            <el-button :plain="true" type="primary" size="" @click="FG_handleOrderDelete" v-if="!FG_order.orderStatus" :disabled="FG_order.readonly"><i
          ...
          <el-row :span="24">
            <div class="commonPanel">
              <el-form class="demo-form-inline" label-width="100px" ref="enterStockAddForm" :inline="true">
                <el-row :span="24">
                  <el-form-item label="业务单号：" prop="id" v-if="FG_order.id">
  ...
  export default {
    ...
    methods: {
      ...
      FG_handleOrderSave(){
        ...
        this.$http(this.$_.merge({}, Action.Stock.stockCheck.add, {
          body:params
        })).then(response => {
          ...
          this.FG_order.data.remark=response.body.attachment.remark
          ...
          this.$confirm('保存成功，是否审核？')
            .then(_ => {
              this.$http(this.$_.merge({}, Action.Stock.stockCheck.audit, {
                ...
                this.FG_order.readonly=true
                this.$router.push({path:'/stock/stockCheck'})
              }, response => {
