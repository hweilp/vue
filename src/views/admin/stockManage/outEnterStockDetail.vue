          ...
          <div class="content">
            ...
            <el-row :span="24" class="fg-content-detail">
              ...
              >
                ...
                <el-table-column prop="store" label="出入库"></el-table-column>
                <el-table-column prop="" label="单号"></el-table-column>

                <el-table-column prop="" label="货号"  width="120"></el-table-column>
                <el-table-column prop="" label="品名"></el-table-column>

                <el-table-column prop="spec" label="规格"></el-table-column>
                <el-table-column prop="unit" label="单位"></el-table-column>

                <el-table-column prop="" label="业务类型" width="100"></el-table-column>
                <el-table-column prop="" label="业务日期" width="100"></el-table-column>
                ...
                <el-table-column prop="moneySum" label="金额"></el-table-column>
