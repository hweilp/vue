          ...
          <div class="content">
            ...
            <el-row :span="24" class="fg-content-detail">
              ...
              >
                ...
                <el-table-column prop="" label="门店名称"></el-table-column>

                <el-table-column prop="" label="货号" sortable width="120"></el-table-column>
                <el-table-column prop="" label="品名"></el-table-column>
                <el-table-column prop="" label="规格"></el-table-column>
                <el-table-column prop="unit" label="单位"></el-table-column>
                <el-table-column prop="" label="库存数量"></el-table-column>
                <el-table-column prop="" label="成本价" sortable></el-table-column>
                <el-table-column prop="" label="成本金额" sortable></el-table-column>
