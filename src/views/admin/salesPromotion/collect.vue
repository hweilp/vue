      ...
      <div class="content">
        ...
        <el-row :span="24" class="fg-content-detail">
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="促销模式 ：" prop="salesType">
                      <el-radio-group v-model="FG_TABLE.pagination.pageFilter.filters.salesType">
                        <el-radio
                          v-for="item in FG_TABLE.pagination.pageFilter.filtersOptions.salestTypeOptions"
                          :key="item.value"
                          :label="item.value"
                        >{{item.label}}
                        </el-radio>
          ...
          >
            ...
            <el-table-column prop="" label="售价价"></el-table-column>

            <el-table-column prop="" label="销售金额"></el-table-column>
            <el-table-column prop="" label="让利金额"></el-table-column>
            <el-table-column prop="" label="类别"></el-table-column>
            <el-table-column prop="" label="品牌"></el-table-column>
            <el-table-column prop="" label="" show-overflow-tooltip></el-table-column>
