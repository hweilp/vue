      ...
      <div class="content">
        ...
        <el-row :span="24" class="fg-content-detail">
          <el-row :span="24" class="fg-content-opr">
            <el-button :plain="true" type="danger" size="" @click="FG_TABLE_END"><i class="fa  fa-minus-circle"></i> 终止
            </el-button>
            ...
            <adv-query left="left:555px">
              <el-form ref="advQueryForm" :model="FG_TABLE.pagination.pageFilter.filters" label-width="100px">
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="促销名称 ：" prop="salesName">

                      <el-input v-model="FG_TABLE.pagination.pageFilter.filters.salesName"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
        ...
        top: -6px;">全选</span>
            ...
            <el-table-column prop="store" label="门店编码" width="120"></el-table-column>
            <el-table-column prop="" label="门店名称" width="140"></el-table-column>
            <el-table-column prop="" label="货号" width="150"></el-table-column>
            <el-table-column prop="" label="品名" width="120"></el-table-column>

            <el-table-column prop="" label="促销模式" width="120"></el-table-column>
            <el-table-column prop="" label="促销名称"></el-table-column>
            <el-table-column prop="" label="会员类别名称"></el-table-column>
            <el-table-column prop="" label="原价" ></el-table-column>
            <el-table-column prop="" label="会员价"></el-table-column>

            <el-table-column prop="" label="特价"></el-table-column>
            <el-table-column prop="" label="每周生效"></el-table-column>
            <el-table-column prop="" label="开始日期"></el-table-column>
            <el-table-column prop="" label="结束日期"></el-table-column>
