...
<script type="text/javascript">
  ...
  export default{
    ...
    created: function () {
      this.formInfo.data.id = this.$route.params.id

      this.$http(_.merge({}, Action.Form.get, {
        url: Helper.FG.setParams(Action.Form.get.url, {id: this.formInfo.data.id}),
      })).then(response => {
        Helper.FG.setValueToObject(this.formInfo.data, response.body)
      }, response => {
        alert(response.body)
      })
    ...
    methods: {
      ...
      submitForm: function (form) {
        this.$http(_.merge({}, Action.Form.update, {
          url: Helper.FG.setParams(Action.Form.update.url, {id: this.formInfo.data.id}),
