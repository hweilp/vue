  ...
  <div id="main" role="main">
    ...
    <div id="content">
      ...
      <div class="opr-layer">
        ...
        <router-link class="btn btn-primary btn-xs" :to="'/formInput/add/'+form.info.id"><i class="fa fa-plus"> </i> 新增字段域</router-link>
    ...
    methods: {
      ...
      refreshData: function () {
        ...
        this.$http(_.merge({}, Action.Form.Input.list, {
          url: Action.Form.Input.list.url + this.form.info.id,
          params: this.filter
        })).then(response => {
      ...
      updateRecord: function (id, data = {}, $event) {
        ...
        //发送数据请求
        this.$http(_.merge({}, Action.Form.Input.update, {
          body: data,
          url: Action.Form.Input.list.url + id
        })).then(response => {
