          ...
          <el-row :span="24" class="fg-content-detail">
            <el-row :span="24" class="fg-content-opr">
              ...
              <advQuery left="left:468px">
                <el-form ref="advQueryForm" :model="FG_advQueryForm" label-width="100px" :inline="true">
                  <el-row :span="24">
                    <datetime-link @on-get-date="getDate" label="日期："></datetime-link>
                  </el-row>
                  <el-row :span="24">
                    <el-form-item label="员工名称：" prop="name">
                      <el-input v-model="FG_advQueryForm.name" style="width: 405px"></el-input>
                    </el-form-item>
                  </el-row>
                  <!--<el-row :span="24">-->
                    <!--<el-form-item label="订单号：" prop="orderNo">-->
                      <!--<el-input v-model="FG_advQueryForm.orderNo" style="width: 405px"></el-input>-->
                    <!--</el-form-item>-->
                  <!--</el-row>-->
                  <!--<el-row :span="24">-->
                    <!--<el-form-item label="银行名称：" prop="bankName">-->

                      <!--<el-select  v-model="FG_advQueryForm.bankName"-->
                                  <!--placeholder="全部" style="width: 405px">-->
                        <!--<el-option v-for="item in FG_TABLE.pagination.pageFilter.bankNameOptions"-->
                                   <!--:key="item.value"-->
                                   <!--:label="item.label"-->
                                   <!--:value="item.value">-->
                        <!--</el-option>-->
                  ...
                  <!--<el-row :span="24">-->
                    <!--<el-form-item label="状态：" prop="tradeStatus">-->
                      <!--<el-select  v-model="FG_advQueryForm.tradeStatus"-->
                                  <!--placeholder="全部" style="width: 405px">-->
                        <!--<el-option v-for="item in FG_TABLE.pagination.pageFilter.merchantStatusOptions"-->
                                   <!--:key="item.value"-->
                                   <!--:label="item.label"-->
...
<script type="text/javascript">
  ...
  export default {
        ...
        FG_TABLE: {
          ...
          pagination: {
            ...
            pageFilter: {
              ...
              bankNameOptions:[
                {value: "", label: "全部"},
                {value: 10, label: "中国工商银行"},
                {value: 20, label: "中国民生银行"},
                {value: 30, label: "中国银行"},
                {value: 30, label: "中国建设银行"},
                {value: 30, label: "中国农村银行"},
                {value: 30, label: "中国农村商业银行"},
                {value: 30, label: "中国平安银行"},
              ],
    ...
    watch: {  "FG_TABLE.pagination.pageFilter.filters.status":function (val) {
    ...
    methods: {
      ...
      FG_TABLE_refreshData: function (option) {
        ...
        this.$http(this.$_.merge({}, Action.System.account.accountCashLog, {
          params
        })).then(response => {
          //表格数据
